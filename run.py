...
user_list, hostname_list, command_list = ssh_multiple_connections(hosts_info)
user_num = len(user_list)
content = "SSH服务器登录信息：\n"
for user, hostname, command in zip(user_list, hostname_list, command_list):
    content += f"用户名：{user}，服务器：{hostname}，命令：{command}\n"
